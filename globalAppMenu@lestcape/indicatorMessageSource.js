 ...
 */
function IndicatorMessageSource(indicator) {
    this._init(indicator);
}

IndicatorMessageSource.prototype = {
    ...
    _init: function(indicator) {
        ...
        this._notification = new IndicatorNotification(this, Lang.bind(this, function() {
            this._iconBox = new AppIndicator.IconActor(this._indicator, this.SOURCE_ICON_SIZE);
            
            if (this._indicator.isReady)
                this._display();
            else
                Util.connectOnce(this._indicator, 'ready', Lang.bind(this, this._display));
        }));
    },
...
function PopupMenuEmbedded() {
    this._init();
}

PopupMenuEmbedded.prototype = {
...
function IndicatorNotification(source, cb) {
    this._init(source, cb);
}

IndicatorNotification.prototype = {
    ...
    _init: function(source, cb) {
        ...
        source._indicator.getMenuClient(Lang.bind(this, function(client) {
            if (client) {
